...
esttab using "${tables}/table_ex2a.tex", replace label title(Consequences of Failing Targets) noobs nobaselevels order(4.i_type 2.i_type 3.i_type) s(N r2_a , label("N" "Adj. R-squared") fmt(0 %9.3f)) star(* .10 ** .05 *** .01) nocon b(3)
