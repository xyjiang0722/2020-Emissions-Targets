...
esttab using "${tables}/table_ex3.tex", replace label title(Summary Statistics - Early vs. Late) cells("mean(pattern(1 1 1 0 0) fmt(3)) sd(pattern(1 1 1 0 0) fmt(3)) b(pattern(0 0 0 1 1) fmt(3)) p(pattern(0 0 0 1 1) fmt(3))") mgroups("(1) Before 2017" "(2) 2017 - 2020" "(3) After 2020" "T-test (1)-(2)" "T-test (1)-(3)", pattern(1 1 1 1 1)) varwidth(30) nonumbers
