...
esttab using "${tables}/table_ex3.tex", replace label title(Summary Statistics - Determinants Have vs. Not) cells("mean(pattern(1 1 0) fmt(3)) sd(pattern(1 1 0) fmt(3)) b(pattern(0 0 1) fmt(3)) p(pattern(0 0 1) fmt(3))") mgroups("With 2020 Targets" "Without 2020 Targets" "Diff" "T-test", pattern(1 1 1 1)) varwidth(30) nonumbers   
